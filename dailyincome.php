  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">ADD DAILY INCOME</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">ADD DAILY INCOME</h3>
   ...
   if(isset($_POST['insert']))
     { 
      ...
      $sql = "INSERT INTO income (description,amount,entrytime,updatetime)
            VALUES ('$description','$amount','$date','$date')";
            if (mysqli_query($db, $sql)) {
              echo '<meta http-equiv="refresh" content="0; url=./dailyincome.php">';
      ...
      <br>
            ...
            <div class="card">
              ...
              <div class="card-body" id="example">
                ...
                $result=mysqli_query($db,"SELECT * FROM income");
                $counter = 0;
            ...
            <td><a href="dailyincome.php?id=<?php echo $row['id'];?>&opr=del ">
...
if($opr=='del'){  
$sql= mysqli_query($db,"DELETE FROM income WHERE id='" . $_GET["id"] . "'");
if (mysqli_query($db, $sql)) {
...
echo "<script>
alert('Data Deleted');
window.location.href = 'dailyincome.php';
</script>";
exit;
}
else{
