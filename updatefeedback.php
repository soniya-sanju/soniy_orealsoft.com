  ...
  $row = mysqli_fetch_array($sqlq); 
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label for="exampleInputname">Enquiry id</label>
                    <input type="number" class="form-control" id="enqid" name="enqid" placeholder="Enquiry id" required  value="<?php echo $row['enqid'];?>" readonly>
                </div> <!-- /.form-group -->               
              </div> <!-- /.col -->
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label for="exampleInputname">Name(Who?)</label>
                    <input type="text" class="form-control" id="staff_name" name="staff_name" placeholder=" Staff Name" requiredvalue="<?php echo $row['staff_name'];?>" >
                </div> <!-- /.form-group -->               
              </div> <!-- /.col -->
              <div class="col-12 col-md-6">
                <div class="form-group">
   ...
   if(isset($_POST['update']))
     { 
      ...
      $sql = mysqli_query($db,"UPDATE feedback  SET enqid='".$enqid."',staff_name='".$staff_name."',Replay='".$Replay."',Description ='".$Description."' WHERE feedback.id='".$id."'");
