    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <?php 
          $sqlq=mysqli_query($db,"SELECT * FROM enquiry WHERE id='".$id."'");
  ...
  $row = mysqli_fetch_array($sqlq); 
   ...
   if(isset($_POST['insert']))
     { 
      ...
      $sql = "INSERT INTO feedback (enqid,staff_name,Replay,Description,Admission_status,updation,entrytime,updatetime)
            VALUES ('$enqid','$staff_name',' $Replay','$Description','$Admission_status','$updation','$date','$date')";
