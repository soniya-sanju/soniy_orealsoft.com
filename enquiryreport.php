...
<button type="submit" name="search" id="search" value="submit" class="btn btn-primary btn-block active">Search</button>
                  ...
                  if(isset($_POST['search']))
                     {
                      ...
                      $result=mysqli_query($db,"SELECT * FROM enquiry WHERE DATE(enquiry.entrytime)between '".$fromdate."' AND '".$todate."' ORDER BY enquiry.id Desc");
                      
                    }else{
                       $result = $db->query("SELECT * FROM enquiry ORDER BY enquiry.id Desc");
            ...
            <td><?php echo $row["enquirymethod"]; ?></td>
            <td><?php echo $row["about_campus"]; ?></td>
...
<?php
    ...
    if(mysqli_affected_rows($db)){
        echo "<script>
        alert('Data Deleted');
        window.location.href = 'enquiryreport.php';
        </script>";
        exit;
      }
    else{
