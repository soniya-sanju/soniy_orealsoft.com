...
<!-- Content Wrapper. Contains page content -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <td><a href="updatecourse.php?id=<?php echo $row['id'];?>&opr=upd ">
              <i style="font-size:18px" class="fa">&#xf044;</i>
            </a></td>
            <td><a href="courseview.php?id=<?php echo $row['id'];?>&opr=del ">
  ...
  <?php
          ...
          if($opr=='del'){  
            $sql= mysqli_query($db,"DELETE FROM course WHERE id='" . $_GET["id"] . "'");
