                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                     ...
                     if(isset($_POST['search']))
                     {
                        ...
                        $result=mysqli_query($db,"SELECT * FROM student_register WHERE DATE(student_register.entrytime)between '".$fromdate."' AND '".$todate."' ORDER BY student_register.id Desc");
          ...
          <!--<td><?php echo ($row['fees'] - $row['payamount']);?></td>-->
            ...
            ?>
                ...
                <div style="float: right;">
                     <h2> <span>Total student : </span>
                      <span><?php echo $total_student; ?></span></h2>
